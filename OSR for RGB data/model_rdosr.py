...
#        self.initlr_F = lr
        ...
        # build the network	
        self.opt_EDC, self.loss_EDC, self.loss_euc, self.loss_sparse = self.build_graph(reuse=reuse)
...
#        input_ae = input_ae_/10
        ...
        return opt_EDC, loss_EDC, loss_euc, loss_sparse
